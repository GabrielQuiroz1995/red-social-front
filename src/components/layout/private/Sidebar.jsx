...
export const Sidebar = () => {
    ...
    const savePublic = async (e) => {
        ...
        // Recoger datos d el formulario 
        let newPublic = form;
        newPublic.user = auth._id;

        // Hacer request para guardar en bd
        const request = await fetch(Global.url+"publication/save", {
            method: "POST",
            body: JSON.stringify(newPublic),
            headers: {
  ...
  return (
    ...
    <div className="aside__container">
        ...
        {stored== 'stored' ? 
          <strong className="alert alert-success">Publicado</strong>
          : ''}
        {stored== 'error' ?
          <strong className="alert alert-danger">Error al publicar</strong>
          : ''}

            <form id='publication-form' className="container-form__form-post" onSubmit={savePublic}>
