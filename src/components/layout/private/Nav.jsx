            ...
            <ul className="container-lists__list-end">
                <li className="list-end__item">
                    <NavLink to={"/social/perfil/"+auth._id} className="list-end__link-image">
                        {auth.image != 'default.png' && <img src={Global.url + 'users/avatar/'+auth.image} className="list-end__img" alt="Foto de perfil"/>}
                ...
                <li className="list-end__item">
                    <NavLink to="/social/configuracion" className="list-end__link">
